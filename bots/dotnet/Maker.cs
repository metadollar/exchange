...
namespace MetaDollar.Bots.DotNet
{
    ...
    {
        public Maker(MetaDollarConfiguration config, ILogger logger = null) : base(config, logger)
        {
            ...
            var buyVolumeToPlace = MetaDollarETH;
            var sellVolumeToPlace = MetaDollarToken;
