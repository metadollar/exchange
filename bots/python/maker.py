#!/usr/bin/python3
#
# maker.py: MetaDollar maker client
# =================================
#
# This client waits until the MetaDollar order book is available,
# determines a good buy and sell price and creates new buy and
# sell orders using the MetaDollar WebSocket API.
#
...
# Installation:
# =============
# This client comes with service.py that contains common MetaDollar API service facilities.
...
# Import our Python MetaDollar API service,
# that automatically maintains the connection,
# updates the order and trade books,
# and allows for reuse of code throughout
# different MetaDollar maker and taker clients.
from metadollarclientservice import MetaDollarClientService

if __name__ == "__main__":
    print("MetaDollar API client in python using websocket")
    ...
    es = MetaDollarClientService()
    es.start(userAccount, token)
    print("MetaDollarClientService started")
