...
from metadollarclientservice import *
...
# Real MetaDollar Contract Address
metaDollarContractAddr = '0x9fB587Fc50B4c5ba8e4947DD9cfbBE7e76A25486'
# Real MTD token
token = '0xA549b1209A7CcadF8BFc654Fc8A373D62c4e5873'
...
class TestTaker(unittest.TestCase):
    ...
    def test_createSellOrder(self):
        ...
        self.assertEqual(result['contractAddr'], metaDollarContractAddr)
