...
MetaDollar has one API endpoint. It is a Websocket API.

 * `https://socket.metadollar.com`
...
MetaDollar has provided [example trading bots](https://github.com/metadollar/bots) to illustrate working functionality.
